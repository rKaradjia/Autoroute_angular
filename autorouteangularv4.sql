...
--
-- Host: localhost    Database: autorouteangularv4
-- ------------------------------------------------------
...
--
-- Current Database: `autorouteangularv4`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `autorouteangularv4` /*!40100 DEFAULT CHARACTER SET latin1 */;

USE `autorouteangularv4`;
...
CREATE TABLE `compte` (
  ...
  `modifabonnement` date DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `compte` VALUES (1,'Karadjia','Reynold','Champs-sur-marne',77420,'rue du chateau','5','rKaradjia','azerty','premium+','2018-08-02'),(2,'Macedo','Goerges','Poissy',78360,'boulevard st germain','14','gMacedo','azerty','basic','2018-08-02'),(3,'Shrize','Mathieu','Chessy',77260,'impasse de la marne','20','mShrize','azer','VIP','2018-07-16'),(4,'Uskegaise','Varbetim','Trappes',78341,'rue saint cyr','82','vUskegaise','azerty','basic','2018-07-01'),(5,'Uskegaise','Daniel','Joinville le pont',94340,'rue de st maur','7','dUskegaise','azerty','premium','2018-06-20');
...
INSERT INTO `reservation` VALUES (1,1,3,'2017-06-29 13:30:00','2017-06-29 14:30:00'),(2,2,13,'2017-07-29 13:15:00','2017-08-29 14:30:00'),(4,1,1,'2018-07-26 13:00:10','2018-07-26 14:40:20'),(5,3,13,'2018-07-28 12:00:53','2018-07-26 14:00:04'),(6,3,4,'2018-07-26 12:30:46','2018-07-26 14:00:53');
...
-- Dump completed on 2018-08-02 12:22:17
